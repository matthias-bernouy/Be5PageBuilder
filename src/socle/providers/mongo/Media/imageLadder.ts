// Whitelisted set of widths the public media endpoint will resize to.
// Lives with the Mongo media provider because it's a backend-validation
// concern: incoming `?w=` parameters are matched against this ladder to
// prevent arbitrary-size resize requests from exhausting `sharp`.
//
// Two tiers:
//
